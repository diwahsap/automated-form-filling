...
# close pengumuman
driver.find_element_by_css_selector('#modal_kue > div > div > div.modal-header > button').click()

# click tab Kuesioner
driver.find_element_by_css_selector('body > div.container.content > div > div.col-md-3 > div:nth-child(2) > a:nth-child(6)').click()

# Kuesioner semester 2022/2023 Ganjil -> ada 5 bagian. Isinya 1@7, 4@3 pertanyaan.
for i in range(1, 2):
    driver.find_element_by_css_selector(f'body > div.container.content > div > div.col-md-9 > div > div.box-body > table:nth-child(3) > tbody > tr:nth-child({i}) > td:nth-child(5) > a').click()
    for i in range(1, 8):
